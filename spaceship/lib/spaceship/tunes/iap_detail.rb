  ...
  module Tunes
    class IAPDetail < TunesBase
      ...
      def save!
        ...
        raw_data.set(["pricingIntervals"], client.transform_intervals_array(application.apple_id, self.purchase_id, pricing_intervals, subscription_price_target))
        ...
        if (raw_data["addOnType"] == Spaceship::Tunes::IAPType::RECURRING)
            client.update_recurring_iap_price!(app_id: application.apple_id, purchase_id: self.purchase_id,
